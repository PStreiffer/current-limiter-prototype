...
(library Library_1
	...
	(patternDef "4304506YY_6" (originalName "4304506YY_6")
		...
		(layerContents (layerNumRef 28)
			(line (pt -9.325 5.885) (pt 3.325 5.885) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.325 5.885) (pt 3.325 -2.885) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.325 -2.885) (pt -9.325 -2.885) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -9.325 -2.885) (pt -9.325 5.885) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "430450627" (originalName "430450627") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.molex.com/pdm_docs/sd/430450227_sd.pdf")
		(attr "<Component Height>" "9.91")
		(attr "<STEP Filename>" "430450627.stp")
		(attr "<STEP Offsets>" "X=-3;Y=1.49;Z=4.9")
